...
onager launch ${settings} --jobname markov_${exp_name}_reacher --tasklist ${tasks}
onager launch ${settings} --jobname markov_${exp_name}_walker --tasklist ${tasks}
onager launch ${settings} --jobname markov_${exp_name}_cheetah --tasklist ${tasks}
